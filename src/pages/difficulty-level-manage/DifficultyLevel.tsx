...
import { getLevel } from "../../services/pages";
...
const DifficultyLevel = () => {
  const [dataList, setDataList] = useState<TypeName[]>([]);
  ...
  const editData = (item: TypeName) => {
    navigate("/level/edit", { state: { item } });
  };
    ...
    <div className="dashboard">
      <div className="header-section">
        <div className="left-section">
          <h3>Difficulty Level List</h3>
        </div>
        <div className="right-section">
          <NavLink className="nav-link" to="/level/add">
            Add New
          </NavLink>
        </div>
      </div>
      <div className="body-section">
        <div className="table-wrapper loader_relative">
